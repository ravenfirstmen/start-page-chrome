import { StartBackgroundImageRotationMessage, LAST_IMAGE_STORAGE_KEY } from "@/shared";
...
class BackgroundImages {
    ...
    async getBackgroundImage(): Promise<string> {
        const backgroundImage = await chrome.storage.local.get(LAST_IMAGE_STORAGE_KEY);
