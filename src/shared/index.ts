...
const StartBackgroundImageRotationMessage = new Message(MessageType.START_BACKGROUND_IMAGE_ROTATION);

type MessageResponse<T> = (response: T) => void;  
type GetBookmarksMessageResponse = MessageResponse<chrome.bookmarks.BookmarkTreeNode[]>;  
